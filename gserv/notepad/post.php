...
echo "<html><head><META HTTP-EQUIV='Refresh' content ='0; URL=http://$host/gserv/notepad/notepad'></head></html>";
}
else
{
if (
...
echo "<meta http-equiv='refresh' content='0;url=http://$host/gserv/notepad/link.html?link=http://$host/x$key'>";
//header("Location: http://$host/gserv/notepad/link.html?link=http://$host/x$key");
}
}
?>
