    ...
    $ussro = file_get_contents ("include/protect/psswd/ussr.php");
	$pswdo = file_get_contents ("include/protect/psswd/pswd.php");
...
<div id="content">
<center>';
$headget = file_get_contents ("include/page/head.txt");
echo  $headget;
echo '
</center>
<div align="right"><a href="adminplace"><font color="#C0C0C0">A</font></a></div>
...
<center>
                ...
                <tr><td bgcolor="green"><b><font color="white" size=-1 color="white" face="verdana,arial"><b><font size="3" color="black" face="Arial">Entrar contrasena</font> </b></font></th></tr>
...
<!-- content -->
<center><i>One sure mark of a fool is to dismiss anything that falls outside his experience as being impossible</i></center> 
<center><h3><b>';
echo ("Your IP: $ipus");
echo '</b></h3></center>
</div></div>
